// fe-progress.js - 基本情報技術者試験講座の学習進捗管理・ブックマーク機能
...
const sections = [
    ...
    { id: 'changes', name: '制度変更点', icon: 'fa-exchange-alt' },
    { id: 'scope', name: '出題範囲', icon: 'fa-chart-pie' },
    { id: 'difficulty', name: '合格率・難易度', icon: 'fa-chart-line' },
    { id: 'time', name: '勉強時間', icon: 'fa-clock' },
    { id: 'plan', name: '学習計画', icon: 'fa-calendar-alt' },
    { id: 'strategy', name: '攻略法', icon: 'fa-bullseye' },
    { id: 'materials', name: 'おすすめ教材', icon: 'fa-book' },
    { id: 'cbt', name: 'CBT試験', icon: 'fa-desktop' },
    { id: 'exemption', name: '科目A免除', icon: 'fa-certificate' },
...
function updateQuizProgress() {
    ...
    const savedAnswers = localStorage.getItem('fe_quiz_answers');
    if (savedAnswers) {
...
function saveProgress() {
    ...
    localStorage.setItem('fe_progress', JSON.stringify(progressData));
}

function loadProgress() {
    const saved = localStorage.getItem('fe_progress');
    if (saved) {
...
function saveBookmarks() {
    ...
    localStorage.setItem('fe_bookmarks', JSON.stringify(bookmarksArray));
}

function loadBookmarks() {
    const saved = localStorage.getItem('fe_bookmarks');
    if (saved) {
