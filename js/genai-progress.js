...
const sections = [
    ...
    { id: 'quiz', name: '練習問題', icon: 'fa-pen-square' },
    { id: 'materials', name: 'おすすめ教材', icon: 'fa-book' },
    { id: 'study', name: '学習方法', icon: 'fa-graduation-cap' }
];
...
function resetProgress() {
    ...
    if (typeof(Storage) !== "undefined") {
        localStorage.removeItem('genai_viewed_sections');
        localStorage.removeItem('genai_study_time');
    }
...
function trackStudyTime() {
    // 保存されている学習時間を読み込み
    if (typeof(Storage) !== "undefined") {
        const savedTime = localStorage.getItem('genai_study_time');
        if (savedTime) {
...
function saveProgress() {
    ...
    localStorage.setItem('genai_viewed_sections', JSON.stringify([...viewedSections]));
    localStorage.setItem('genai_study_time', totalStudyTime.toString());
}
...
function loadProgress() {
    ...
    const savedSections = localStorage.getItem('genai_viewed_sections');
    if (savedSections) {
...
function saveBookmarks() {
    ...
    localStorage.setItem('genai_bookmarks', JSON.stringify([...bookmarks]));
}
...
function loadBookmarks() {
    ...
    const savedBookmarks = localStorage.getItem('genai_bookmarks');
    if (savedBookmarks) {
