...
function resetProgress() {
    ...
    if (typeof(Storage) !== "undefined") {
        localStorage.removeItem('mos_viewed_sections');
        localStorage.removeItem('mos_study_time');
    }
...
function trackStudyTime() {
    // 保存されている学習時間を読み込み
    if (typeof(Storage) !== "undefined") {
        const savedTime = localStorage.getItem('mos_study_time');
        if (savedTime) {
...
function saveProgress() {
    ...
    localStorage.setItem('mos_viewed_sections', JSON.stringify([...viewedSections]));
    localStorage.setItem('mos_study_time', totalStudyTime.toString());
}
...
function loadProgress() {
    ...
    const savedSections = localStorage.getItem('mos_viewed_sections');
    if (savedSections) {
...
function saveBookmarks() {
    ...
    localStorage.setItem('mos_bookmarks', JSON.stringify([...bookmarks]));
}
...
function loadBookmarks() {
    ...
    const savedBookmarks = localStorage.getItem('mos_bookmarks');
    if (savedBookmarks) {
