// gcp-cdl.js - GCP Cloud Digital Leader講座ページ専用JavaScript

console.log('gcp-cdl.js ファイル読み込み開始');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (tocNav && tocToggle) {
        // 初期状態: 折りたたまれた状態
        const savedState = localStorage.getItem('gcp_cdl_toc_state');
        ...
        tocToggle.addEventListener('click', function() {
            ...
            localStorage.setItem('gcp_cdl_toc_state', isExpanded ? 'expanded' : 'collapsed');
        });
            ...
            item.addEventListener('click', function() {
                if (window.innerWidth < 1024) {
                    setTimeout(() => {
                        ...
                        localStorage.setItem('gcp_cdl_toc_state', 'collapsed');
                    }, 300);
                }
            });
        });
